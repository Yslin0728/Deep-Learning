...
import numpy as np
#from .ImageFolderDataset import load_image_as_numpy
...
class RescaleTransform:
    ...
    def __call__(self, images):
        ...
        image_min = images - self._data_min
        max_min = self._data_max - self._data_min
        images = image_min / max_min
...
class NormalizeTransform:
    ...
    def __call__(self, images):
        ...
        if (len(self.mean)>1 and len(self.std)>1):
